...
echo ""
echo -e "${CYAN}Benchmark (vastar):${NC}"
echo "  vastar -m POST -T 'application/json' \\"
echo "    -d '{\"model\":\"gpt-4\",\"messages\":[{\"role\":\"user\",\"content\":\"bench\"}]}' \\"
echo "    -c 200 -n 3000 http://localhost:${PORT}/v1/chat/completions"
echo ""
echo -e "${CYAN}Benchmark (hey):${NC}"
echo "  hey -m POST -T 'application/json' \\"
echo "    -d '{\"model\":\"gpt-4\",\"messages\":[{\"role\":\"user\",\"content\":\"bench\"}]}' \\"
echo "    -c 200 -n 3000 http://localhost:${PORT}/v1/chat/completions"
echo ""
